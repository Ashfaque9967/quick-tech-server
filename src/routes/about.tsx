...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Northrack" },
      { name: "description", content: "Northrack is an Indian enterprise infrastructure firm specialising in server parts, maintenance, leasing, and 24/7 support." },
      { property: "og:title", content: "About — Northrack" },
      ...
      <section className="hairline-b">
        <div className="container-swiss py-20 md:py-28 grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 max-w-2xl space-y-6 text-lg leading-relaxed">
            <p>
              Founded in 2011 in Bengaluru, Northrack was built on a simple premise: enterprise infrastructure is too critical to be handled by ticket queues and unfamiliar voices.
            </p>
